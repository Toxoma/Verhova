...
Chromosome chromosome2 = new Chromosome(new List<Gen>(){(Gen)gen1.Clone(), (Gen)gen1.Clone()});
Chromosome chromosome3 = new Chromosome(new List<Gen>(){(Gen)gen2.Clone(), (Gen)gen1.Clone()});
Chromosome chromosome4 = new Chromosome(new List<Gen>(){(Gen)gen2.Clone(), (Gen)gen2.Clone()});
